...
st.set_page_config(page_title="Scanner Saham BUY & SELL", layout="wide")
st.title("📊 Scanner Saham BUY & SELL")
...
def cek_saham(ticker, periode):
    try:
        ...
        # Hitung ATR buat estimasi hari ke TP
        ...
        # Sinyal BUY - sama persis kayak versi lama
        ...
        # Sinyal SELL - sama persis kayak versi lama
